...
import com.huawei.hms.mlkit.sample.transactor.ImageFaceTransactor;
...
public class LensEngine {
    ...
    private ImageFaceTransactor imageFaceTransactor;
    ...
    public void release() {
        synchronized (this.transactorLock) {
            ...
            if (this.imageFaceTransactor != null) {
                this.imageFaceTransactor.stop();
                this.imageFaceTransactor = null;
            }
        }
    }
    ...
    public void setMachineLearningFrameTransactor(ImageTransactor transactor, ImageFaceTransactor imageFaceTransactor) {
        synchronized (this.transactorLock) {
            if (this.frameTransactor != null) {
                this.frameTransactor.stop();
            }
            ...
            this.imageFaceTransactor = imageFaceTransactor;
        }
    }
            ...
            while (true) {
                ...
                try {
                    synchronized (LensEngine.this.transactorLock) {
                        ...
                        LensEngine.this.imageFaceTransactor.process(
                                data,
                                new FrameMetadata.Builder()
                                        .setWidth(LensEngine.this.selector.getPreviewSize().getWidth())
                                        .setHeight(LensEngine.this.selector.getPreviewSize().getHeight())
