...
import com.huawei.hms.mlkit.sample.util.NV21ToBitmapConverter;
import com.huawei.hms.mlkit.sample.views.overlay.GraphicOverlay;
import com.huawei.hms.mlsdk.common.MLFrame;

import java.nio.ByteBuffer;

public abstract class BaseFaceTransactor<T> implements ImageFaceTransactor {
    ...
    public BaseFaceTransactor() {
    }

    public BaseFaceTransactor(Context context) {
                        ...
                        new OnSuccessListener<T>() {
                            ...
                            public void onSuccess(T results) {
                                if (metadata == null || metadata.getCameraFacing() == CameraConfiguration.getCameraFacing()) {
                                    BaseFaceTransactor.this.onSuccess(bitmap, results, metadata, graphicOverlay);
                                }
                                BaseFaceTransactor.this.processLatestImage(graphicOverlay);
                            }
                        })
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(Exception e) {
                                BaseFaceTransactor.this.onFailure(e);
                            }
                        });
    }
